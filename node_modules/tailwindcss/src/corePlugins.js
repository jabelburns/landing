...
import {
  ...
  isScreenSortable,
  compareScreens,
  toScreen} from './util/normalizeScreens'
...
export let variantPlugins = {
  ...
  pseudoClassVariants: ({ addVariant, matchVariant, config, prefix }) => {
    let pseudoVariants = [
      ...
      'active',
      'enabled',
      'disabled'].map((variant) => (Array.isArray(variant) ? variant : [variant, `&:${variant}`]))
...
export let corePlugins = {
  ...
  ringOpacity: (helpers) => {
    ...
    return createUtilityPlugin('ringOpacity', [['ring-opacity', ['--tw-ring-opacity']]], {
      filterDefault: !flagEnabled(config(), 'respectDefaultRingColorOpacity')})(helpers)
  },
