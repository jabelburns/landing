...
import {
  ...
  SOURCE_LINE,
  SOURCE_COLUMN,
  NAMES_INDEX} from './sourcemap-segment';
...
export function setSourceContent(map: GenMapping, source: string, content: string | null): void {
  const {
    ...
    // _originalScopes: originalScopes} = cast(map);
...
export function toDecodedMap(map: GenMapping): DecodedSourceMap {
  const {
    ...
    // _generatedRanges: generatedRanges} = cast(map);
