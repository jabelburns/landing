...
declare namespace AtRule {
  export interface AtRuleRaws extends Record<string, unknown> {
    ...
    /**
     * The ruleâ€™s selector with comments.
     */
    params?: {
      raw: string
      value: string
...
declare class AtRule_ extends Container {
  /**
   * An array containing the layerâ€™s children.
   *
   * ```js
  ...
  type: 'atrule'
  /**
   * The at-ruleâ€™s name immediately follows the `@`.
   *
   * ```js
  ...
  /**
   * The at-ruleâ€™s parameters, the values that follow the at-ruleâ€™s name
